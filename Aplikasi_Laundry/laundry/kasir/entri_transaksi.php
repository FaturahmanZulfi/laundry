            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Entri Transaksi</h6>
                </div>
                <div class="card-body">
                      ...
                      <?php $no = 1; foreach($records as $record) : ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="bayar_transaksi.php?id_transaksi=<?= $record['id_transaksi'] ?>" class="btn btn-warning btn-icon-split" onclick="return confirm('anda yakin ingin menyelesaikan pembayaran data ini ?')">
                              <span class="icon text-white-100">
                                Bayar
                              </span>
                            </a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Buat Data Transaksi</h5>
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="inlineFormCustomSelectPref">Member</label>
            <div class="col-sm-10">
              <select class="form-control" id="inlineFormCustomSelectPref" name="member">
              <?php 
                $options = read('member');
                foreach($options as $option) :
               ?>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control datepicker" name="batas_waktu" id="bawa">
            </div>
          </div>
          <div class="form-group row">
            <label for="number" class="col-sm-2 col-form-label">Biaya Tambahan</label>
            <div class="col-sm-10" id="only-number">
              <input type="text" name="bita" id="number" class="form-control">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="inlineFormCustomSelectPref">Paket</label>
            <div class="col-sm-10">
              <select class="form-control" id="inlineFormCustomSelectPref" name="paket">
              <?php 
                $options = read('paket');
                foreach($options as $option) :
               ?>
          ...
          <div class="form-group row">
            <label for="number" class="col-sm-2 col-form-label">Qty</label>
            <div class="col-sm-10" id="only-number">
              <input type="text" name="qty" id="number" class="form-control">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="inlineFormCustomSelectPref">User</label>
            <div class="col-sm-10">
              <select class="form-control" id="inlineFormCustomSelectPref" name="qty" disabled>
              <?php 
                $options = read('user','*',"WHERE id = $id_user");
                foreach($options as $option) :
               ?>
                <option value="<?= $option['id'] ?>"><?= $option['nama'] ?></option>
              <?php endforeach; ?>
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-primary" name="create" value="Buat">
        </div>
          </form>
      </div>
    </div>
