<?php 
  ...
  if (ISSET($_POST['update'])) {
    ...
    $table = 'paket';
    $field = "nama_paket = '$nama_paket',jenis = '$jenis',harga = '$harga',id_outlet = '$outlet'";
    $knd = "WHERE id = $id";
                  ...
                  <form method="POST">
                    <div class="modal-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="namap" class="form-control" id="namap" value="<?= $value['nama_paket'] ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control" id="inlineFormCustomSelectPreff" name="jenisp">
                            <option value="kiloan" <?php if($value['jenis'] == 'kiloan'){ ?> selected <?php } ?>>Kiloan</option>
                            <option value="selimut" <?php if($value['jenis'] == 'selimut'){ ?> selected <?php } ?>>Selimut</option>
                            <option value="bed_cover" <?php if($value['jenis'] == 'bed_cover'){ ?> selected <?php } ?>>Bed Cover</option>
                            <option value="kaos" <?php if($value['jenis'] == 'kaos'){ ?> selected <?php } ?>>kaos</option>
                            <option value="lain" <?php if($value['jenis'] == 'lain'){ ?> selected <?php } ?>>Lainr</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="hargap" class="form-control" id="hargap" value="<?= $value['harga'] ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                    ...
                    <div class="modal-footer">
                      <a href="paket.php" class="btn btn-secondary" type="button" data-dismiss="modal">Kembali</a>
