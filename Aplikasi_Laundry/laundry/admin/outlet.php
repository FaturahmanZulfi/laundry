                    ...
                    <tbody>
                      <?php $no = 1; foreach($records as $record) : ?>
                        <tr>
                          ...
                          <td><?= $record['telp'] ?></td>
                          <td>
                            <a href="edit_outlet.php?id=<?= $record['id'] ?>" class="btn btn-warning btn-icon-split">
                              <span class="icon text-white-100">
                          ...
                          <td>
                            <a href="delete_outlet.php?id=<?= $record['id'] ?>" onclick="return confirm('anda yakin ingin menghapus data ini ?')" class="btn btn-danger btn-icon-split">
                              <span class="icon text-white-100">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            <label for="number" class="col-sm-2 col-form-label">Telp Outlet</label>
            <div class="col-sm-10" id="only-number">
              <input type="text" name="telpo" class="form-control" id="number">
            </div>
          </div>
