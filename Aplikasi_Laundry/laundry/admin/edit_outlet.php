            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Ubah Data Outlet</h6>
                </div>
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="namao" class="form-control" id="namao" value="<?= $value['nama'] ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="alamato" class="col-sm-2 col-form-label">Alamat Outlet</label>
                    <div class="col-sm-10">
                      <input type="text" name="alamato" class="form-control" id="alamato" value="<?= $value['alamat'] ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="telpo" class="col-sm-2 col-form-label">Telp Outlet</label>
                    <div class="col-sm-10" id="only-number">
                      <input type="text" name="telpo" class="form-control" id="number" value="<?= $value['telp'] ?>">
                    </div>
                  </div>

                  <a href="outlet.php" class="btn btn-secondary" type="button" data-dismiss="modal">Kembali</a>
