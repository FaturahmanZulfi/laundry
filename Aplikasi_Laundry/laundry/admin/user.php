<?php 
  ...
  $sql = "SELECT user.id as id,user.nama,user.username,user.password,outlet.nama as outlet,user.role FROM user INNER JOIN outlet ON user.id_outlet = outlet.id";
  ...
  if (ISSET($_POST['create'])) {
    ...
    $role = $_POST['role'];
    $table = 'user';
    $field = ['nama','username','password','id_outlet','role'];
    $values = ["'$nama'","'$username'","'$password'","'$outlet'","'$role'"];
                    ...
                    <tbody>
                      <?php $no = 1; foreach($records as $record) : ?>
                        <tr>
                          ...
                          <td><?= $record['role'] ?></td>
                          <td>
                            <a href="edit_user.php?id=<?= $record['id'] ?>" class="btn btn-warning btn-icon-split">
                              <span class="icon text-white-100">
                          ...
                          <td>
                            <a href="delete_user.php?id=<?= $record['id'] ?>" onclick="return confirm('anda yakin ingin menghapus data ini ?')" class="btn btn-danger btn-icon-split">
                              <span class="icon text-white-100">
